...
tar -xvf indexes/lucene-index-dbpedia_annotated_full.tar.gz
...
tar -xvf resources/wikipedia2vec/wikipedia-20190701/wikipedia2vec_500.pkl.tar.gz
...
tar -xvf output/monobert-large-msmarco-dbpedia_acc_batch_64_e6_annotated.tar.gz
...
tar -xvf output/monobert-large-msmarco-dbpedia_acc_batch_64_e6_noent.tar.gz
